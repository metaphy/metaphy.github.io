...
RedShift居然没有UUID函数，但是有Random()，可以这样写：
```
SELECT 
    (FLOOR(RANDOM() * 9223372036854775807)::bigint)::text AS uuid,
    RANDOM() AS rand
```

|uuid | rand |  
| ---- | ---- | 
|5272548631885414400 | 0.7800906673978432 | 
...
**[例24]有一个职员表t_employee, 有字段employee_id和employee_name等**
